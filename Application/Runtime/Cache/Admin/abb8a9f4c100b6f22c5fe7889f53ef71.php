...
<title>会员列表 - <?php echo get_opinion('title','option_value');?></title>
</head>
<body>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"  href="add"><i class="Hui-iconfont">&#xe600;</i> 添加会员</a></span> <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span> </div>
			<div class="mt-20">
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tmp): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td><?php echo (date("Y-m-d",$tmp["times"])); ?></td>
							<td>
								<?php if($tmp["static"] != null): echo Sec2Time($tmp[beentime]);?>
								<?php else: ?>无限制<?php endif; ?>
							</td>
							<td class="td-manage"><a style="text-decoration:none" class="ml-5" href="edit?id=<?php echo ($tmp["id"]); ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,<?php echo ($tmp["id"]); ?>)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
